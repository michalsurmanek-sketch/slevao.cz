...
const runtimeVersion = '20260829-1';
assert.match(index, new RegExp(`assets/home-autopilot\\.js\\?v=${runtimeVersion}`), 'Homepage nenačítá aktuální Prague-safe Autopilot.');
assert.ok(
