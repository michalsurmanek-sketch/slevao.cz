...
assert(allStores.includes("select: 'store_id,name,slug,logo_url,primary_color,is_active,feed_status,current_offer_count,current_leaflet_count,image_coverage_pct,health_score'"), 'Veřejný seznam musí používat skutečný sloupec store_id z feed-health view.');
