...
for (const page of storePageFiles) {
  ...
  if (['pepco','petcenter','planeo','sinsay','takko','makro','rohlik','kosik','super-zoo','hornbach','mountfield','alza','datart','decathlon','sconto','moebelix','xxxlutz','sportisimo','smarty','pilulka','auto-kelly','dek','pro-doma','stavmat','hm','hruska','tedi','new-yorker'].includes(slug)) {
