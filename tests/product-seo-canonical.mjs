...
const html = fs.readFileSync(new URL('../produkt.html', import.meta.url), 'utf8');
...
assert.match(html, /assets\/product-seo\.js\?v=20260816-1/, 'Product page must load the canonical-fix version of product-seo.js.');
