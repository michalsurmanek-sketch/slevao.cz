...
test('homepage keeps mobile hero styles bundled and stays at 27 CSS requests', async ({ page }) => {
  ...
  expect(stylesheets.length, `Expected at most 27 homepage CSS requests, got ${stylesheets.length}`).toBeLessThanOrEqual(27);
