...
test('homepage keeps radius selector styles bundled and stays at 26 CSS requests', async ({ page }) => {
  ...
  expect(stylesheets.length, `Expected at most 26 homepage CSS requests, got ${stylesheets.length}`).toBeLessThanOrEqual(26);
