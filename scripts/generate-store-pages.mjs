...
<footer><div class="c"><strong>SLEVAO.cz</strong><p>Platné slevy českých obchodů na jednom místě.</p></div></footer><script>window.SLEVAO_STORE=${JSON.stringify({slug,name})}</script><script src="assets/store-feed.js?v=20260801-2"></script></body></html>
`;
