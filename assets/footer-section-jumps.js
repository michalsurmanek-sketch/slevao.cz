(() => {
  ...
  const ITEMS = [
    { href:'#saveToday', fallback:'.sqSaveTodayWrap', label:'Ušetři mi dnes peníze', icon:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3l1.45 4.25a4.5 4.5 0 0 0 2.85 2.85l4.25 1.45-4.25 1.45a4.5 4.5 0 0 0-2.85 2.85L12 20l-1.45-4.25a4.5 4.5 0 0 0-2.85-2.85l-4.25-1.45 4.25-1.45a4.5 4.5 0 0 0 2.85-2.85L12 3Z"/></svg>' },
  ...
  if (!document.getElementById(styleId)) {
    ...
    style.textContent = `
      ...
      .footerQuickIcons.footerSectionJumpIcons a:nth-child(1) svg,.footerQuickIcons.footerSectionJumpIcons a:nth-child(3) svg,.footerQuickIcons.footerSectionJumpIcons a:nth-child(4) svg,.footerQuickIcons.footerSectionJumpIcons a:nth-child(7) svg{fill:currentColor;stroke:none}
