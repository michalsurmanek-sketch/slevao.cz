(() => {
  ...
  const ITEMS = [
    ...
    { href:'#quickFoodDock', fallback:'.sqFoodDock', label:'Rychlý nákup', icon:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 5h2l2.1 9.1a2 2 0 0 0 2 1.5h7.8a2 2 0 0 0 1.9-1.4L21 8H6"/><circle cx="9.5" cy="19" r="1.4"/><circle cx="17.5" cy="19" r="1.4"/></svg>' },
    { href:'#dealsSection', label:'Nabídky', icon:'<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="7" cy="7" r="2.2"/><circle cx="17" cy="17" r="2.2"/><path d="M18.5 4.5 5.5 19.5"/></svg>' },
    { href:'#q', label:'Hledej', icon:'<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="10.5" cy="10.5" r="6.5"/><path d="m15.5 15.5 5 5"/></svg>' },
