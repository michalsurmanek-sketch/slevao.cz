(() => {
  ...
  // Zkratky používají stejné motivy jako kruhové oddělovače sekcí na homepage.
  const ITEMS = [
  ...
  if (!document.getElementById(styleId)) {
    ...
    style.textContent = `
      ...
      .footerQuickIcons.footerSectionJumpIcons>a{width:54px!important;height:54px!important;display:grid!important;place-items:center!important;flex:0 0 54px!important;padding:0!important;border:1px solid rgba(255,255,255,.30)!important;border-radius:14px!important;background:rgba(255,255,255,.025)!important;color:#fff!important;text-decoration:none!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.04)!important;transition:transform .16s ease,border-color .16s ease,background .16s ease!important}
      .footerQuickIcons.footerSectionJumpIcons>a:hover{transform:translateY(-2px);border-color:#fff!important;background:rgba(255,255,255,.10)!important}
