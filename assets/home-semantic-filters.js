(() => {
  ...
  const CONFIG = {
    ...
    ovoce: { label:'Ovoce', title:'Ovoce v akci', info:'Zobrazujeme čerstvé, mražené a sušené ovoce podle zvoleného filtru', icon:'🍎', types:[['ovoce','Vše'],['jablka','Jablka'],['banany','Banány'],['citrusy','Citrusy'],['bobulove','Bobulové'],['exoticke','Exotické']], forms:[['cerstve ovoce','Čerstvé','♧'],['mrazene ovoce','Mražené','❄'],['susene ovoce','Sušené','◒']] },
    zelenina: { label:'Zelenina', title:'Zelenina v akci', info:'Zobrazujeme zeleninu a zeleninové výrobky podle zvoleného filtru', icon:'🥕', types:[['zelenina','Vše'],['brambory','Brambory'],['rajcata','Rajčata'],['papriky','Papriky'],['cibule','Cibule'],['korenova zelenina','Kořenová'],['listova zelenina','Listová']], forms:[['cerstva zelenina','Čerstvá','♧'],['mrazena zelenina','Mražená','❄'],['sterilovana zelenina','Sterilovaná','◒'],['zeleninove vyrobky','Výrobky','▱']] }
  };
