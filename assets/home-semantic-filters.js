(() => {
  ...
  const CONFIG = {
    ...
    zelenina: { label:'Zelenina', title:'Čerstvá zelenina v akci', info:'Zobrazujeme jen skutečně čerstvou zeleninu', icon:'🥕', types:[['zelenina','Vše'],['brambory','Brambory'],['rajcata','Rajčata'],['papriky','Papriky'],['cibule','Cibule'],['korenova zelenina','Kořenová'],['listova zelenina','Listová']], forms:[['zelenina','Čerstvá','♧'],['mrazena zelenina','Mražená','❄'],['sterilovana zelenina','Sterilovaná','◒'],['zeleninove vyrobky','Výrobky','▱']] }
  };
