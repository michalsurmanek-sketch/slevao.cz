(() => {
  ...
  function leafletCard(leaflet) {
    ...
    const externalOfferLabels = {
      pepco: 'Prohlédnout nabídku na Pepco.cz ↗',
      petcenter: 'Prohlédnout výprodej na PetCenter.cz ↗',
      planeo: 'Prohlédnout akce na Planeo.cz ↗',
      sinsay: 'Prohlédnout nabídky na Sinsay.com ↗',
      takko: 'Prohlédnout nabídky na Takko.com ↗',
      makro: 'Prohlédnout aktuální nabídky na Makro.cz ↗',
      rohlik: 'Prohlédnout Cenové trháky na Rohlík.cz ↗',
    ...
    return `${open}
      ...
      <div class="leafletBody">
        ...
        <span class="leafletAction">${canPreview ? 'Prolistovat přímo zde' : (externalOfferLabels[storeSlug] || 'Otevřít oficiální leták')}</span>
      </div>
    ${close}`;
  }
