(() => {
  ...
  function leafletCard(leaflet) {
    ...
    const isExternalWebOffer = ['pepco', 'petcenter', 'planeo', 'sinsay', 'takko', 'makro'].includes(storeSlug);
