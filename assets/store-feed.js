(() => {
  ...
  function leafletCard(leaflet) {
    ...
    const isExternalWebOffer = ['pepco', 'petcenter', 'planeo', 'sinsay', 'takko', 'makro', 'rohlik'].includes(storeSlug);
