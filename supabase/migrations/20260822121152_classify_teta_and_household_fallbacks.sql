...
begin
  return case
    ...
    when n ~ '\m(vonne tycinky|aroma tycinky|vonny olej|difuzer|svicka|svice|pohlcovac vlhkosti|balici papir|papir na peceni|pytle na odpadky|odpadkove pytle|odpadove pytle|pytel na tezky odpad)\M' then 'home'
    when n ~ '\m(sprchovy gel|sprchovy krem|wc blok|wc gel|damske vlozky|slipove vlozky|tampony|lak na vlasy|telovy peeling|denni krem|krem na nohy|cistici prostredek|myci prostredek|prostredek na nadobi|osvezovac vzduchu|vlhcene ubrousky|papirove kapesniky|repelent|antibakterial)\M'
      or n ~ '\m(dermacol|max factor|wet n wild|pampers|swiffer)\M'
      or n ~ '\m(inkontinencni|hygienicke vlozky|cistici ubrousky|detske cistici ubrousky|pleny|anti perspirant|deosprej|chlorax|tablety do mycky|prachovky|cistici hadriky)\M'
      or n ~ '\mcif\M.*\mkrem\M'
