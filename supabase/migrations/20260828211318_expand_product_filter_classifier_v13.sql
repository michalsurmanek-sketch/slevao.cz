-- Third narrow expansion: fashion inflections, Glade home fragrance, and medicinal-tablet collision repair.
...
begin
  ...
  if n ~ '(^| )(kratasy|cepice|nazouvaky|pyzamo|minisaty|pantofle|t shirt)( |$)'
  ...
  -- Personal-care / household fragrance product types.
...
parallel safe
set search_path to ''
as $function$ select 13; $function$;
