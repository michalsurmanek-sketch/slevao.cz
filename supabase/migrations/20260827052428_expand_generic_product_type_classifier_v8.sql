...
begin
  ...
  if n ~ '(^| )(mikina|teplaky|bunda|halenka|kosile|sukne|tilko|vesta|boxerky|kalhoty|dziny|bluza|tricko|triko|trika|saty|sortky|ponozky|leginy|svetr|kabat|obuv|boty|tenisky)( |$)' then return 'fashion'; end if;
  ...
  -- Obecné produktové typy. Domácí náčiní má přednost před jídlem,
  -- aby např. lžíce na špagety nebyla potravina.
