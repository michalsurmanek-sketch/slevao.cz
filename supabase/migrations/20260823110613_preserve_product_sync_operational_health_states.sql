...
select slug,
       ...
       case
         ...
         when state_health_status in ('waiting_source','not_applicable','blocked','degraded','running') then state_health_status
         when state_health_status='error' or last_error is not null then 'error'::text
