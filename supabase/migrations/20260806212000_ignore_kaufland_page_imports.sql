-- Nabídky Kaufland jsou publikované samostatně v offers a nejsou navázané
-- přes flyer_id. Jednotlivé stránkové importy proto můžeme skrýt stavem
-- ignored, aniž by zmizely produkty. Veřejný feed pak obsahuje jen celé PDF.
