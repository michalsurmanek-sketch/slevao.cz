...
with parsed as materialized (
  ...
  join public.offers o
   ...
   and (o.metadata-'import_id'-'source_signature'-'imported_at')=p.metadata
...
revoke all on function private.penny_structured_html_matches_published_set(text,uuid,text,integer,date,date)
  from public, anon, authenticated, service_role;
grant execute on function private.penny_structured_html_matches_published_set(text,uuid,text,integer,date,date)
  to postgres;