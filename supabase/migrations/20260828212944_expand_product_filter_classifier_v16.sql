-- Sixth narrow expansion: high-confidence cosmetics/personal care and a few clear foods.
...
begin
  ...
  if n ~ '(^| )(pelmeni)( |$)'
     ...
     or n ~ '(^| )susene maso( |$)'
     or n ~ '(^| )(susene datle|tofu s bazalkou|rozinky thompson|krupave ovoce)( |$)' then
    return 'food';
  end if;
