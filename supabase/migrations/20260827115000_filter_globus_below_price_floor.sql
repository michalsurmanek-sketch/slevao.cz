-- Globus's official structured API can legitimately contain an item below the
-- global 2 CZK public-offer floor. Keep the global quality barrier intact and
-- filter only this trusted branch snapshot before the generic structured publisher.
