-- Reject Lidl products when a preceding legal block exists but does not explicitly
-- match the current leaflet window (e.g. long-term "Ceny v klidu" sections).
-- Also normalize quantities without a trailing decimal separator (80 g, not 80. g).
