...
begin
  ...
  -- Kandidáty hledáme v hlavním názvu i v již potvrzených aliasech.
  -- Aktuální product_id nevyřazujeme: při jediné přesné shodě může zůstat zachován.
  with candidates as (
  ...
  if candidate_count = 1 then
    ...
    -- Více stejných historických produktů: automaticky vybíráme pouze tehdy,
    -- když právě jeden z nich má ověřenou kvalitní fotografii.
    with approved as (
...
-- Okamžitě očistí případné zbylé nekvalitní výřezy a použije ověřený master obrázek.
