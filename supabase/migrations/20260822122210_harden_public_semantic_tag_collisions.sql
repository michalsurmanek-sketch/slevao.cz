...
begin
  ...
  meat := s ~ '\m(maso|masov[a-z0-9]*|vepr[a-z0-9]*|hovez[a-z0-9]*|kure[a-z0-9]*|kurec[a-z0-9]*|kruti|kruta|kruty|kachn[a-z0-9]*|jehnec[a-z0-9]*|kralik[a-z0-9]*|krkovic[a-z0-9]*|kyta|plec|kotlet[a-z0-9]*|panenk[a-z0-9]*|svickov[a-z0-9]*|rosten[a-z0-9]*|steak[a-z0-9]*|zebro|zebra|zeber|bucek|koleno|gulasov[a-z0-9]*|jatr[a-z0-9]*|steh[a-z0-9]*|kridl[a-z0-9]*|palick[a-z0-9]*)\M'
    or prsa_meat;

  chicken := s ~ '\m(kure[a-z0-9]*|kurec[a-z0-9]*|steh[a-z0-9]*|kridl[a-z0-9]*|palick[a-z0-9]*)\M'
    or prsa_meat;
