...
as $function$
  select case
    ...
    when public.normalize_text(coalesce(p_name,'')) ~ '\m(sampon|mydlo|deodorant|zubni|ustni|pletova|avivaz|cistic|toaletni|plenky|kosmetika|antiperspirant|serum|makeup|dezinfekce|micelarni|odlicovac|rtenka|rasenka|praci|mycka)\M' then 'drugstore'
